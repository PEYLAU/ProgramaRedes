...
public class PeerMessageTest {
	...
	public static void main(String[] args) throws IOException {
		 ...
		 */
		PeerMessage msgOut = new PeerMessage(PeerMessageOps.OPCODE_DOWNLOAD_CHUNK);
		msgOut.setParametro1(175000);
		msgOut.setParametro2(7);
		...
		if (msgOut.getOpcode() != msgIn.getOpcode()) {
			...
			System.out.println("Opcode does match!");
